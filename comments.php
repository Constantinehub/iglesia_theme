...
?>
    ...
    <div class="comments-container">
        ...
        <h3 class="comments_section_title"><?php echo _e('Comments','aletheme'); ?></h3>
                    ...
                    <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" id="comment-form" method="post" class="comment-form">
                        ...
                        <?php else : ?>
                            <div class="form-item personal cf">
                                ...
                                <input type="url" placeholder="<?php _e('Your website', 'aletheme'); ?>" class="site" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" tabindex="3" >
                                <input type="email" placeholder="<?php _e('Your e-mail', 'aletheme'); ?>" class="email" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> required="required" email="true">
                            </div>
                        <?php endif; ?>
